                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Thêm dung lượng</h5>
                                            ...
                                            <div class="modal-body">
                                                <form action="" id="add_color_form" method="POST">
                                                    ...
                                                    <button id="add_memory_button" type="submit"
                    ...
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button data-bs-toggle="modal" data-bs-target="#deletememory<?php echo $i['id']?>"
                                            class="btn btn-danger btn-sm m-2">
                                            Xóa
                                    </button>
                                        <div class="modal fade" id="deletememory<?php echo $i['id']?>" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Xóa dung lượng</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button data-color-id="<?php echo $i['id'];?>"
                                                            class="btn btn-danger m-2 delete-memory">Yes</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function(){
        $('#add_memory_button').on('click',function(){
            // alert('hieu pro');
            name = $('#name').val();
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo BASE_URL ?>/admin/memory/insertMemory',
                data:{
                    name: name,
                    status: status
                },
                success:function(response){
                    ...
                    if(response.success){
                        ...
                        var modal = $('#addMemoryModal');
                        modal.modal('hide');
                        location.reload();
                    }else{
                        alert("Lỗi khi thêm dung lượng");
                    }
                },error:function(){
