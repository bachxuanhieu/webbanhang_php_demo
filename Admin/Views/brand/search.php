                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- xóa nhãn hàng  ------------------------------------------------------------------------------------------------------>
                                    <button data-bs-toggle="modal" data-bs-target="#deleteBrandModal"
                                    ...
                                    <div class="modal fade" id="editBrandModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" id="edit_brand" method="POST">
                                                        <input type="hidden" id="edit_id_brand" name="edit_id_brand">
                                                        <div class="mb-3">
                                                            <label>Tên nhãn hàng</label>
                                                            <input type="text" class="form-control"
                                                                id="edit_title_brand" name="edit_title_brand" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label>Miêu tả nhãn hàng</label>
                                                            <textarea id="edit_desc_brand" class="form-control"
                                                                name="edit_desc_brand" required></textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label>Danh mục sản phẩm</label>
                                                            <select id="edit_category_product"
                                                                name="edit_category_product" class="form-label"
                                                                required>
                                                                <?php
                                                                foreach ($categories as $key => $i) {
                                                                ?>
                                                        ...
                                                        <button id="edit_brand_button" type="submit"
